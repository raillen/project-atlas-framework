...
| HA6 | 2nd ModelProvider + Gateway/fallback | ACCEPTED | partial (gateway routing/fallback/CB done; 2nd real vendor adapter pending) |
...
- [~] versioned public protocol (envelope + schemas started; full IDL pending)
- [~] reconnect/replay (resume+handoff CLI done; daemon reconnect pending)
