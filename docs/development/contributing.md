...
Read `AGENTS.md`, `ENTRYPOINT.md`, `FRAMEWORK.md`, and `docs/PRUMO.md` before changing behavior. New work must preserve the provider-neutral core policy and Lean Progressive Context discipline.
