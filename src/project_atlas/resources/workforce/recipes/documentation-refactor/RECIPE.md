...
## Purpose
Reorganize canonical docs, docs/ATLAS.md navigation, and audience split without document proliferation.
...
4. **Validate links and ATLAS routing** (`verify-links`)
   - **Role:** `reviewer`
   - **Skills:** `documentation`
...
- **Gates:** `review`
- **Artifacts:** `Synchronized canonical Markdown`, `Updated docs/ATLAS.md`
