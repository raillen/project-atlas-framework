# MCP Protocol Security — Technical Reference Guide

## Overview & Purpose
Verify Model Context Protocol server trust boundaries, tool parameter sanitization, and output validation.
