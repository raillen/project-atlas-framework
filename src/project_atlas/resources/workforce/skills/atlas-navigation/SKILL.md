...
## Use when
- Active Goal or Task explicitly requires atlas navigation operations.
- Operating in mode(s): `research`.

## Do not use when
- Task is out of scope or unrelated to atlas navigation.
...
## Procedure
1. Initialize minimal context for atlas navigation.
