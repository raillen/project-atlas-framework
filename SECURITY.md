...
Project Atlas generates instructions/configuration for AI-assisted development. Treat agent permissions, context retrieval and orchestrator automation as code with real operational impact.
...
- Do not store provider secrets in `atlas.json`, profiles or model-policy files.
